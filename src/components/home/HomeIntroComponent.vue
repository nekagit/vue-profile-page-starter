...
import intro01 from '@/assets/SOP/basket.jpg'
import intro02 from '@/assets/SOP/run.jpg'
import intro03 from '@/assets/SOP/tennis.jpg'
import intro04 from '@/assets/SOP/boks.jpg'
