<template>
  <div class="pt-8">
    <div
      class="h-screen md:h-auto overflow-auto grid sm:grid-cols-2 items-center gap-8 p-8 m-8 max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]"
    >
      <div>
        <h1 class="text-3xl font-extrabold">Let's Talk</h1>
        <p class="text-sm text-gray-400 mt-3 text-wrap">
          Wanna get in contact with us no problem just fill out the form or directly message through
